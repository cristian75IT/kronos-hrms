...
import { SmartWorkingAgreements } from '../../components/users/SmartWorkingAgreements';
...
export function UserDetailPage() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'contracts' | 'wallet' | 'training' | 'smartworking'>((searchParams.get('tab') as 'overview' | 'contracts' | 'wallet' | 'training' | 'smartworking') || 'overview');
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-6 items-start">
                ...
                <div>
                    <div className="flex gap-1 border-b border-gray-200 mb-6">
                        ...
                        <button
                            className={`flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'smartworking'
                                ? 'border-teal-600 text-teal-600'
                                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                }`}
                            onClick={() => setActiveTab('smartworking')}
                        >
                            <Laptop size={16} /> Smart Working
                        </button>
                    </div>
                    ...
                    <div className="min-h-[400px]">
                        ...
                        {activeTab === 'smartworking' && id && (
                            <div className="animate-fadeIn">
                                <SmartWorkingAgreements userId={id} userName={`${user.first_name} ${user.last_name}`} />
                            </div>
                        )}
                    </div>
                </div>
