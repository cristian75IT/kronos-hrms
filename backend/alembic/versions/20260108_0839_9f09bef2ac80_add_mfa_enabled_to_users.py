...
Revision ID: 9f09bef2ac80
Revises: e1f019348a55
Create Date: 2026-01-08 08:39:31.385534+00:00
...
revision: str = '9f09bef2ac80'
down_revision: Union[str, None] = 'e1f019348a55'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('mfa_enabled', sa.Boolean(), nullable=False, server_default=sa.false()), schema='auth')
    # Optional: remove the server default if you don't want it to persist as a default constraints
    op.alter_column('users', 'mfa_enabled', server_default=None, schema='auth')
...
def downgrade() -> None:
    ...
    op.alter_column('roles', 'updated_at',
               ...
               existing_server_default=sa.text('now()'),
               schema='auth')
    op.add_column('users', sa.Column('mfa_enabled', sa.Boolean(), nullable=False), schema='auth')
